...
Ext.define('Skirtle.grid.column.Component', {
    ...
    createTemplate: function(tpl) {
        return tpl && tpl.isTemplate
            ? tpl
            : Ext.create('Skirtle.CTemplate', tpl || [
                '{literal}{', this.dataIndex ,'}{/literal}'
            ]);
    },
                ...
                if (Ext.isIE) {
                    ...
                    if (parent) {
                        if (me.extVersion === 40101) {
                            ...
                            Ext.core.DomHelper.insertBefore(dom, {
                                tag: 'p'
                            });
                        }
